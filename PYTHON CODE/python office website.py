...
if ch == 1:
    ...
    """)
        ...
        if admin_ch == 1:
            ...
            for i in range (len(employees)):
                if employees[i]["emp_id"] == emp_id:
                    print("Enter new details to update",emp_id)
                    employees[i]["emp_name"] = input("Enter the updated name:")
                    employees[i]["emp_dept"] = input("Enter the updated dept:")
                    employees[i]["emp_salary"] = input("Enter the updated salary:")
                    print("Your Update ahas been Succesful")
                    break
